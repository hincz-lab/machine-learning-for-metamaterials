...
def define_model(x):
    ...
    modname = dr+'general_5lay4matinverse_model_v-tma_convolution_rt2pd_'+str(st)+'step_'+date.strftime("%Y")+date.strftime("%m")+date.strftime("%d")
...
hparams = np.array([3,0,1759,1743,1437,0.002978762488432,0.005351256908853])
