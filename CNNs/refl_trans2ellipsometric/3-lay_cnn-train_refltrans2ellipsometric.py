...
num_lay = 3
num_wave = 200
(ml1,ml2,ml3,ml4,ml5,th,ang,rp,rs,tp,ts,psi,delta) = readin_data('/home/arl92/Documents/newdata/data_rte_gen3lay5mat_0ge_240000n_v-tma_20201112.h5',num_mat,num_ang,num_lay,num_wave)
...
def define_model(x):
    ...
    modname = dr+'general_3lay4matinverse_model_v-tma_convolution_rt2pd_'+str(st)+'step_'+date.strftime("%Y")+date.strftime("%m")+date.strftime("%d")
...
hparams = np.array([4,0,643,1940,1249,0.000149238120758,0.009329062697472])
