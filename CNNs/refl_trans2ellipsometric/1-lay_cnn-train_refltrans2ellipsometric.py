...
def define_model(x):
    ...
    modname = dr+'general_1lay4matinverse_model_v-tma_convolution_rt2pd_'+str(st)+'step_'+date.strftime("%Y")+date.strftime("%m")+date.strftime("%d")
...
hparams = np.array([3,0,1179,632,1453,0.000251350659753,0.001644874366683])
