...
(m1r,m2r,thr,angr,rpr,rsr,tpr,tsr,psir,deltar) = split_data(ml1,ml2,th,ang,rp,rs,tp,ts,psi,delta,0,tr)
(m1v,m2v,thv,angv,rpv,rsv,tpv,tsv,psiv,deltav) = split_data(ml1,ml2,th,ang,rp,rs,tp,ts,psi,delta,tr,va)
...
def define_model(x):
    ...
    modname = dr+'general_2lay4matinverse_model_v-tma_convolution_rt2pd_'+str(st)+'step_'+date.strftime("%Y")+date.strftime("%m")+date.strftime("%d")
...
hparams = np.array([4,0,1788,1134,1349,3.16204864430902E-05,0.005534624593097])
