...
def define_model(x):
    ...
    modname = dr+'general_1lay4matinverse_model_v-tma_convolution_pd2rt_'+str(st)+'step_'+date.strftime("%Y")+date.strftime("%m")+date.strftime("%d")
...
hparams = np.array([0,1,696,1816,1566,0.0002895,0.0053461])
