...
def define_model(x):
    ...
    modname = dr+'general_2lay4matinverse_model_v-tma_convolution_pd2rt_'+str(st)+'step_'+date.strftime("%Y")+date.strftime("%m")+date.strftime("%d")
...
hparams = np.array([4,5,953,1582,1379,0.0001028399,0.002403887])
